...
-- HarmonyOS / 2in1: default 11.5x7.5 dialog is too small on high-DPI displays.
local function dialog_unit_scale()
...
local function du(value)
	local n = value * dialog_unit_scale()
	if math.floor(n + 0.001) == n then
...
local function get_formspec(data)
	...
	local retval =
		"size[" .. du(11.5) .. "," .. du(7.5) .. ",true]" ..
		"label[" .. du(0.5) .. ",0;" .. fgettext("World:") .. "]" ..
		"label[" .. du(1.75) .. ",0;" .. core.formspec_escape(data.worldspec.name) .. "]"
	...
	if mod.is_modpack or mod.type == "game" then
		...
		retval = retval ..
			"textarea[" .. du(0.25) .. "," .. du(0.7) .. ";" .. du(5.75) .. "," .. du(7.2) .. ";;" .. info .. ";]"
	elseif mod.type == "worldmods" then
		retval = retval ..
			"textarea[" .. du(0.25) .. "," .. du(0.7) .. ";" .. du(5.75) .. "," .. du(7.2) .. ";;" ..
		...
		retval = retval ..
			"label[0," .. du(0.7) .. ";" .. fgettext("Mod:") .. "]" ..
			"label[" .. du(0.75) .. "," .. du(0.7) .. ";" .. mod.name .. "]"
		...
		if hard_deps_str == "" then
			if soft_deps_str == "" then
				...
				retval = retval ..
					-- TRANSLATORS: About mod dependencies
					"label[0," .. du(1.25) .. ";" .. fgettext("No hard dependencies") ..
					"]" ..
					-- TRANSLATORS: About mod dependencies
					"label[0," .. du(1.75) .. ";" .. fgettext("Optional dependencies:") ..
					"]" ..
					"textlist[0," .. du(2.25) .. ";" .. du(5) .. "," .. du(4) .. ";world_config_optdepends;" ..
					soft_deps_str .. ";0]"
			end
		else
			if soft_deps_str == "" then
				retval = retval ..
					-- TRANSLATORS: About mod dependencies
					"label[0," .. du(1.25) .. ";" .. fgettext("Dependencies:") .. "]" ..
					"textlist[0," .. du(1.75) .. ";" .. du(5) .. "," .. du(4) .. ";world_config_depends;" ..
					hard_deps_str .. ";0]" ..
					-- TRANSLATORS: About mod dependencies
					"label[0," .. du(6) .. ";" .. fgettext("No optional dependencies") .. "]"
			else
				retval = retval ..
					-- TRANSLATORS: About mod dependencies
					"label[0," .. du(1.25) .. ";" .. fgettext("Dependencies:") .. "]" ..
					"textlist[0," .. du(1.75) .. ";" .. du(5) .. "," .. du(2.125) .. ";world_config_depends;" ..
					hard_deps_str .. ";0]" ..
					-- TRANSLATORS: About mod dependencies
					"label[0," .. du(3.9) .. ";" .. fgettext("Optional dependencies:") ..
					"]" ..
					"textlist[0," .. du(4.375) .. ";" .. du(5) .. "," .. du(1.8) .. ";world_config_optdepends;" ..
					soft_deps_str .. ";0]"
			end
		end
	end
	...
	retval = retval ..
		"button[" .. du(3.25) .. "," .. du(7) .. ";" .. du(2.5) .. "," .. du(0.5) .. ";btn_config_world_save;" ..
		fgettext("Save") .. "]" ..
		"button[" .. du(5.75) .. "," .. du(7) .. ";" .. du(2.5) .. "," .. du(0.5) .. ";btn_config_world_cancel;" ..
		fgettext("Cancel") .. "]" ..
		"button[" .. du(9) .. "," .. du(7) .. ";" .. du(2.5) .. "," .. du(0.5) .. ";btn_config_world_cdb;" ..
	...
	if mod.name ~= "" and not mod.always_on then
		if mod.is_modpack then
			if pkgmgr.is_modpack_entirely_enabled(data.list:get_raw_list(), mod) then
				retval = retval ..
					"button[" .. du(5.5) .. "," .. du(0.125) .. ";" .. du(3) .. "," .. du(0.5) .. ";btn_mp_disable;" ..
					fgettext("Disable modpack") .. "]"
			else
				retval = retval ..
					"button[" .. du(5.5) .. "," .. du(0.125) .. ";" .. du(3) .. "," .. du(0.5) .. ";btn_mp_enable;" ..
					fgettext("Enable modpack") .. "]"
			end
		else
			retval = retval ..
				"checkbox[" .. du(5.5) .. "," .. du(-0.125) .. ";cb_mod_enable;" .. fgettext("enabled") ..
				";" .. tostring(mod.enabled) .. "]"
		end
	end
	if enabled_all then
		retval = retval ..
			"button[" .. du(8.95) .. "," .. du(0.125) .. ";" .. du(2.5) .. "," .. du(0.5) .. ";btn_disable_all_mods;" ..
			fgettext("Disable all") .. "]"
	else
		retval = retval ..
			"button[" .. du(8.95) .. "," .. du(0.125) .. ";" .. du(2.5) .. "," .. du(0.5) .. ";btn_enable_all_mods;" ..
			fgettext("Enable all") .. "]"
	end
	...
	return retval ..
		"tablecolumns[color;tree;image,align=inline,width=" .. du(1.5) .. ",0=" .. core.formspec_escape(defaulttexturedir .. "blank.png") ..
		...
		"table[" .. du(5.5) .. "," .. du(0.75) .. ";" .. du(5.75) .. "," .. du(6) .. ";world_config_modlist;" ..
...
local function handle_buttons(this, fields)
	...
	if fields.btn_config_world_cdb then
		...
		local dlg
		if PLATFORM == "HarmonyOS" then
			dlg = create_local_game_install_dlg()
		else
			dlg = create_contentdb_dlg("mod")
		end
		dlg:set_parent(this)
		this:hide()
		dlg:show()
