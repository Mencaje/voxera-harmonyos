...
local function create_world_formspec(dialogdata)
	...
	local retval =
		...
		-- Left side
		"container[0," .. top .. "]"..
		"field[" .. left_pad .. "," .. layout.y_world .. ";" .. field_w .. "," .. field_h .. ";te_world_name;" ..
		fgettext("World name") ..
	...
	if not disallowed_mapgen_settings["seed"] then
		...
		retval = retval .. "field[" .. left_pad .. "," .. layout.y_seed .. ";" .. field_w .. "," .. field_h .. ";te_seed;" ..
	...
	retval = retval ..
		...
		"dropdown[" .. left_pad .. "," .. layout.y_mg_dd .. ";" .. field_w .. "," .. field_h ..
