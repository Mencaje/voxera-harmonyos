...
public:
	...
	{
		SHWBufferLink_opengl(const scene::HWBuffer *buf) :
				SHWBufferLink(buf),
				Vbo(buf->getBufferType() == scene::HWBuffer::Type::INDEX ?
						OGLBufferObject::TARGET_EBO : OGLBufferObject::TARGET_VBO)
		{}
...
private:
	...
	OGLBufferObject QuadIndexVBO = OGLBufferObject(OGLBufferObject::TARGET_EBO);
