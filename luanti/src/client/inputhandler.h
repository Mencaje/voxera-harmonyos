...
#ifdef __OHOS__
	/** Sync physical key state from SDL after ArkUI/NAPI injection (fallback path). */
	void syncFromSdlKeyboard();
#endif
...
#ifdef __OHOS__
	virtual void syncPlatformInput() {}
#endif
...
#ifdef __OHOS__
	void syncPlatformInput() override
	{
		m_receiver->syncFromSdlKeyboard();
	}
#endif
