...
#include "util/string.h"
	...
	#define gettext(String) porting::ohosMenuGettext(String)
	#define ngettext(String1, String2, n) \
		((n) == 1 ? porting::ohosMenuGettext(String1) : porting::ohosMenuGettext(String2))
#else
