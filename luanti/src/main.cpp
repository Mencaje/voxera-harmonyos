...
#ifdef __OHOS__
		porting::ohosEngineStatusSet("main: cannot create user data dir");
#endif
		return 1;
	}
...
#ifdef __OHOS__
		porting::ohosEngineStatusSet("main: init_common failed");
#endif
		return 1;
	}
...
#ifdef __OHOS__
		porting::ohosEngineStatusSet("main: game_configure failed");
#endif
		return 1;
	}
