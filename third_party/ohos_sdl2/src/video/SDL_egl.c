...
#elif SDL_VIDEO_DRIVER_OHOS
/* OpenHarmony / HarmonyOS NDK (same as entry: libEGL + libGLESv3) */
#define DEFAULT_EGL "libEGL.so"
#define DEFAULT_OGL_ES2 "libGLESv3.so"
#define DEFAULT_OGL_ES_PVR "libGLESv2.so"
#define DEFAULT_OGL_ES "libGLESv2.so"
