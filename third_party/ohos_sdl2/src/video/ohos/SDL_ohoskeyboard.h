...
/** Thread-safe: enqueue from ArkUI / XComponent / NAPI; flush on the SDL engine thread. */
extern void OHOS_QueueKeyEvent(int keycode, int down);
extern void OHOS_FlushQueuedKeyEvents(void);
